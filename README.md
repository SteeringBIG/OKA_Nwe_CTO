...
(
  id                int auto_increment
    primary key,
  date_upd          date                 not null comment 'Дата внесения информации',
  mex_code          int(3)               not null comment 'Код механника',
  ...
  kkm_sno           char(50)             null comment 'Система налогооблажения',
  ...
  groups_product    char(100)            null comment 'Группы товаров',
